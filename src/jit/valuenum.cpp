...
//                 index calculations.
//
void Compiler::vnAddExceptionSetForIndirection(GenTree* tree)
{
...
//
void Compiler::vnAddExceptionSetForDivision(GenTree* tree)
{
    genTreeOps oper = tree->OperGet();
...
//                 exception set.
//
void Compiler::vnAddExceptionSetForOverflow(GenTree* tree)
{
...
//                 exception set.
//
void Compiler::vnAddExceptionSetForCkFinite(GenTree* tree)
{
...
//
void Compiler::vnAddExceptionSet(GenTree* tree)
{
    if (tree->OperMayThrow(this))
    {
        switch (tree->OperGet())
        {
            ...
            case GT_SUB:
            case GT_MUL:
                vnAddExceptionSetForOverflow(tree);
                break;
            ...
            case GT_NULLCHECK:  // Explicit null check.
                vnAddExceptionSetForIndirection(tree);
                break;
            ...
            case GT_MOD:
            case GT_UMOD:
                vnAddExceptionSetForDivision(tree);
                break;

            case GT_CKFINITE:
                vnAddExceptionSetForCkFinite(tree);
                break;

            default:
                assert(!"Handle this oper in vnAddExceptionSet");
                break;
        }
    }
}
